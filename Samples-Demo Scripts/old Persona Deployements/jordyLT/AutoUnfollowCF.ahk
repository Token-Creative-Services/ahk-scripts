...
#NoEnv ; Recommended for performance and compatibility wpith future AutoHotkey releases.
SetWorkingDir %A_ProgramFiles% ; Ensures a consistent starting directory.
SendMode Input ; Recommended for new scripts due to its superior speed and reliability.

#include C:\Program Files\Token\Automation\classes\crowdFireWebApp.ahk  
