...
class crowdFireWebApp {
	...
	SetToJSniderLaptop() 
	{
		try {
			...
			This.time_menuToggleTime := "2000"
			This.time_ListLoadTime := "4000"
			This.time_admirerListLoadTime := "15000"
			This.time_initalLaunchLoadTime := "11000"
			This.time_actionButtonPressInterval := "105"
			This.time_likeButtonPressInterval := "400"
			This.time_profileSwapDelay := "500"
	...
	setTotokenJetLT() 
	{
		try {
			...
			This.y_admirerButton := "420"
			This.x_unfollowButton := "1061"
			This.y_unfollowButton := "164"
