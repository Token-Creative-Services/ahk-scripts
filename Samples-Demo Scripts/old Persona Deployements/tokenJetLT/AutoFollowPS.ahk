 ...
 ; Hot Keys: [P]-Exit
 ;
 ; TO DEPLOY: a)Replace working script directory(for classes framework)     b)Create/Configure user defining method for respective class(Set [igApp] context to user-specific method)		c) Set file name to 'Like3PicsOfTop5Followers.ahk'
 ; ----------------------------------------------------
 ; ----------------------------------------------------
